...
// Draw line 
function drawFirstLine(colorChoosen, font, firstLine, fontSize) {
    gCtx.font = fontSize + 'px ' + font;
    gCtx.strokeStyle = 'black';
    gCtx.lineWidth = 6;
    gCtx.textAlign = 'center';
    gCtx.strokeText(firstLine, gCanvas.width / 2, 85);
    gCtx.fillStyle = colorChoosen;
    gCtx.fillText(firstLine, gCanvas.width / 2, 85);
}
...
function onDoMeme() {
    var colorChoosen = document.querySelector('.txt-color').value;
    var font = document.querySelector('.font').value;
    var secondLine = document.querySelector('.second-line').value;
    var fontSize = document.querySelector(".fontSize").value;

    gMeme.txts = createTxt(secondLine,fontSize,'center',colorChoosen,gCanvas.width / 2,85)
    var img = new Image();
    ...
    img.onload = function () {
        ...
        gCtx.drawImage(img, 0, 0);
        drawFirstLine(colorChoosen, font, secondLine, fontSize)
    }
